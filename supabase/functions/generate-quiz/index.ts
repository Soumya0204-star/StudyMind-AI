    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are a quiz generator for students. Generate exactly 5 quiz questions for active recall practice. Return ONLY valid JSON array, no markdown.`
          },
          {
            role: "user",
            content: `Generate 5 quiz questions from:
Topic: ${topic}
